...
#include <com/quicinc/cne/server/2.0/IServerCallback.h>
using ::com::quicinc::cne::server::V2_0::IServerCallback;
...
public:
  ...
  void setServerCb(const sp<IServerCallback> serverCb);
  void clearServerCb(const sp<IServerCallback> serverCb);
  void resetServerCb();
...
private:
  ...
  static sp<IServerCallback> m_serverCb;
