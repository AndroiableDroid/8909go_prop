...
*/
#define CNE_MSG_VERBOSE( ... )         CneMsg::cne_log_class_ptr->printReleaseLog( CNE_VERBOSE_LEVEL, SUB_TYPE, __FILE__, __LINE__,  __VA_ARGS__ )
#define CNE_MSG_DEBUG( ... )           CneMsg::cne_log_class_ptr->printReleaseLog( CNE_DEBUG_LEVEL, SUB_TYPE, __FILE__, __LINE__,  __VA_ARGS__ )
#define CNE_MSG_INFO( ... )            CneMsg::cne_log_class_ptr->printReleaseLog( CNE_INFO_LEVEL, SUB_TYPE, __FILE__, __LINE__,  __VA_ARGS__ )
