...
import com.qualcomm.qti.backup_wrapper.SystemPropertiesWrapper;
...
public class BackupActivity extends ExpandableListActivity
    ...
    /** Remove Third-party App Backup/Restore feature
    ...
    **/
    ...
    /** Remove Calendar Backup/Restore feature
    ...
    **/
    ...
    private class BackupAdapter extends SimpleExpandableListAdapter {
        ...
        public View getGroupView(int groupPosition, boolean isExpanded,
            ...
            /** Can show all System data items as Remove Third-party App Backup/Restore feature, don't need expand/collapse group
...
//    }
    ...
    public boolean isChecked() {
        ...
        if (flag == false) {
            ...
            Log.d(TAG, "isChecked() apps size: " + ret[0]);
            flag = (ret[0] > 0);
        }
        **/
