...
import com.qualcomm.qti.backup_wrapper.SystemServiceWrapper;
...
public class OldRecoverOperateActivity extends PreferenceActivity implements OnVcsInsertListener {
    ...
    private class Showconnectprogress extends ProgressDialog {
        ...
        public Showconnectprogress(Context context) {
            this(context, ResourcesWrapper.style.Theme_Dialog_Alert);
            mContext = context;
        }
                                ...
                                new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog, int whichButton)
                                    {
                                      ...
                                      //  SystemService.stop("restoreAppData");
                                        try {
                                            SystemServiceWrapper.stop("restoreAppData");
                                        } catch (WrapperNotSupportException wrapperE) {
                                            Log.e(TAG,"stop: catch an exception ", wrapperE);
                                        }
