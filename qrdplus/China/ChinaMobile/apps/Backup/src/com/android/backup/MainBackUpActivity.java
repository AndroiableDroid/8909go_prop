...
public class MainBackUpActivity extends TabActivity implements TabHost.OnTabChangeListener {
    ...
    private void initLocation() {
        ...
        if (null == sharedPreferences.getString(BackupUtils.KEY_BACKUP_LOCATION, null)) {
            ...
            editor.putString(BackupUtils.KEY_BACKUP_LOCATION, BackupUtils.strInternalPath).commit();
        }
        if (null == sharedPreferences.getString(BackupUtils.KEY_RESTORE_LOCATION, null)) {
            Log.d(TAG, "set restore location: " );
            SharedPreferences.Editor editor = sharedPreferences.edit();
            editor.putString(BackupUtils.KEY_RESTORE_LOCATION, BackupUtils.strInternalPath).commit();
        }
    }
