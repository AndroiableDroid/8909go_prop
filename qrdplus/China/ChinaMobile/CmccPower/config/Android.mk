...
$(shell mkdir -p $(GENERATED_PACKAGE_PATH)/CmccPower)
$(shell cp -r $(LOCAL_PATH)/$(PRE_LOAD_SPEC) $(GENERATED_PACKAGE_PATH)/CmccPower/$(PRE_LOAD_SPEC))

#################################################
EXCLUDE_LIST := exclude.list
$(shell mkdir -p $(GENERATED_PACKAGE_PATH)/CmccPower)
$(shell cp -r $(LOCAL_PATH)/$(EXCLUDE_LIST) $(GENERATED_PACKAGE_PATH)/CmccPower/$(EXCLUDE_LIST))

#################################################
SPEC_PROP := power.prop
$(shell mkdir -p $(GENERATED_PACKAGE_PATH)/CmccPower/system/vendor/)
$(shell cp -r $(LOCAL_PATH)/$(SPEC_PROP) $(GENERATED_PACKAGE_PATH)/CmccPower/system/vendor/$(SPEC_PROP))
