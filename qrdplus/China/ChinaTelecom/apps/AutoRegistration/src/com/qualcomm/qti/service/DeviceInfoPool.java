...
public class DeviceInfoPool {
    ...
    public enum NodeParm {
        ...
        UETYPE, SIM1ICCID, SIM2ICCID, SIM1GIMSI, SIM1LTEIMSI, SIM2LTEIMSI, SIM1TYPE, SIM2CDMAIMSI,
        SID, NID, MACID,

        MODELCTA, MANUFACTURE, OSVER, HWVER, PNAME, COLOR, MLPLVER, MSPLVER, CELLID, MMEID,
        ACCESSTYPE, REGDATE, IMEI1, IMEI2, BASEID,
    ...
    public void getMeid(Message message) {
        ...
        if (invalidMeid(meid)) {
            Phone phone = getPhoneInstance(mPhoneId);
            if (phone != null) {
                meid =  phone.getMeid();
                if (invalidMeid(meid)) {
