...
BOARD_PLATFORM_LIST += msmpeafowl
...
IS_MSMPEAFOWL:=$(strip $(call is-board-platform,msmpeafowl))
...
ifneq (,$(IS_MSM8996)$(IS_MSM8996GVMQ)$(IS_MSM8937))
...
ifneq (,$(IS_MSM8909)$(IS_MSM8952)$(IS_MSM8937)$(IS_MSM8953))
