...
void ResetHandler::reset_to_default_values(OptsData &d) {
    ...
    defval = fopen("/data/vendor/perfd/default_values", "a+");
    if (defval == NULL) {
    ...
    if (ftell(defval) == 0) {
        ...
        write_to_file(defval, "gpu_min_freq", GPU_MIN_FREQ);
        write_to_file(defval, "gpu_max_freq", GPU_MAX_FREQ);
        write_to_file(defval, "gpu_bus_min_freq", GPU_BUS_MIN_FREQ);
        write_to_file(defval, "gpu_bus_max_freq", GPU_BUS_MAX_FREQ);
        ...
        write_to_file(defval, "tl2pc_perf", TOGGLE_L2_PC_PERF);
        ...
        write_to_file(defval, "llcminf", d.llcbw_minfreq_path);
        write_to_file(defval, "llcmaxf", d.llcbw_maxfreq_path);
        write_to_file(defval, "l3lminf", d.l3l_minfreq_path);
        write_to_file(defval, "l3bminf", d.l3b_minfreq_path);
        write_to_file(defval, "memlat_ratio_ceil_0", MEMLAT_RATIO_CEIL_0);
        write_to_file(defval, "memlat_ratio_ceil_1", MEMLAT_RATIO_CEIL_1);
        ...
        write_to_file(defval, "bg_sys_cpuset", SCHED_SYSTEM_BACKGROUND_CPUSET);
        ...
        write_to_file(defval, "sgum", SCHED_GROUP_UPMIGRATE);
        write_to_file(defval, "sgdm", SCHED_GROUP_DOWNMIGRATE);
        write_to_file(defval, "sfreqat", SCHED_FREQ_AGGREGATE_THRESHOLD);
        write_to_file(defval, "lbh", LPM_BIAS_HYST);
        write_to_file(defval, "lpm_ref_stddev", LPM_LEVELS_REF_STDDEV);
        write_to_file(defval, "lpm_trm_add", LPM_LEVELS_TMR_ADD);
        write_to_file(defval, "disable_ppr", DISABLE_PPR);
        ...
        write_to_node(defval, "gpu_min_freq", GPU_MIN_FREQ);
        write_to_node(defval, "gpu_max_freq", GPU_MAX_FREQ);
        write_to_node(defval, "gpu_bus_min_freq", GPU_BUS_MIN_FREQ);
        write_to_node(defval, "gpu_bus_max_freq", GPU_BUS_MAX_FREQ);
        ...
        write_to_node(defval, "tl2pc_perf", TOGGLE_L2_PC_PERF);
        ...
        write_to_node(defval, "llcminf", d.llcbw_minfreq_path);
        write_to_node(defval, "llcmaxf", d.llcbw_maxfreq_path);
        write_to_node(defval, "l3lminf", d.l3l_minfreq_path);
        write_to_node(defval, "l3bminf", d.l3b_minfreq_path);
        write_to_node(defval, "memlat_ratio_ceil_0", MEMLAT_RATIO_CEIL_0);
        write_to_node(defval, "memlat_ratio_ceil_1", MEMLAT_RATIO_CEIL_1);
        ...
        write_to_node(defval, "bg_sys_cpuset", SCHED_SYSTEM_BACKGROUND_CPUSET);
        ...
        write_to_node(defval, "sgum", SCHED_GROUP_UPMIGRATE);
        write_to_node(defval, "sgdm", SCHED_GROUP_DOWNMIGRATE);
        write_to_node(defval, "sfreqat", SCHED_FREQ_AGGREGATE_THRESHOLD);
        write_to_node(defval, "lbh", LPM_BIAS_HYST);
        write_to_node(defval, "lpm_ref_stddev", LPM_LEVELS_REF_STDDEV);
        write_to_node(defval, "lpm_trm_add", LPM_LEVELS_TMR_ADD);
        write_to_node(defval, "disable_ppr", DISABLE_PPR);
...
void ResetHandler::reset_freq_to_default(OptsData &d) {
    ...
    Target &t = Target::getCurTarget();
    int startcpu, endcpu, restoreVal;
#ifdef PERFD
    char tmp_s[NODE_MAX];
    int reqval = 0;
    ...
    restoreVal = t.getCpuMaxFreqResetVal(0);
    rc = update_freq_node(0, t.getLastCoreIndex(0), restoreVal, tmp_s, NODE_MAX);
    if (rc >= 0) {
    ...
    if (t.getCoresInCluster(1) > 0) {
        ...
        restoreVal = t.getCpuMaxFreqResetVal(1);
        rc = update_freq_node(t.getLastCoreIndex(0)+1, t.getLastCoreIndex(1), restoreVal, tmp_s, NODE_MAX);
        if (rc >= 0) {
...
void ResetHandler::reset_cpu_nodes(int cpu) {
    ...
    defval = fopen("/data/vendor/perfd/default_values", "r");
    if(defval == NULL) {
