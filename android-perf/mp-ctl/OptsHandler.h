...
class OptsHandler {
    ...
    private:
        ...
        /*Toggle L2 PC of perf cluster*/
        static int toggle_l2_pc_perf(Resource &r, OptsData &d);

        /*set lpm values*/
        static int lpm_bias_hyst(Resource &r, OptsData &d);
        static int lpm_ref_stddev(Resource &r, OptsData &d);
        static int lpm_trm_add(Resource &r, OptsData &d);
        ...
        static int sched_top_app_cpuset(Resource &r, OptsData &d);
        static int sched_fg_cpuset(Resource &r, OptsData &d);
        static int sched_sys_bg_cpuset(Resource &r, OptsData &d);
        static int sched_bg_cpuset(Resource &r, OptsData &d);
        static int sched_set_freq_aggr(Resource &r, OptsData &d);
        static int sched_set_enable_thread_grouping(Resource &r, OptsData &d);
        static int sched_group_upmigrate(Resource &r, OptsData &d);
        static int sched_group_downmigrate(Resource &r, OptsData &d);
        static int sched_freq_aggr_threshold(Resource &r, OptsData &d);
	static int sched_update_restore_cpuset(Resource &r, const char *cpuset_node,
                                              char *input_cpuset_str = NULL, bool is_fg = false);
        ...
        static int gpu_min_freq(Resource &r, OptsData &d);
        static int gpu_max_freq(Resource &r, OptsData &d);
        static int gpu_bus_min_freq(Resource &r, OptsData &d);
        static int gpu_bus_max_freq(Resource &r, OptsData &d);
        ...
        static int disable_ppr(Resource &r, OptsData &d);
        static int keep_alive(Resource &r, OptsData &d);
        static void* keep_alive_thread(void*);

        /*llcbw hwmon actions*/
        static int llcbw_hwmon_min_freq(Resource &r, OptsData &d);

        /*memlat (l3, l2) actions*/
        static int l3_min_freq(Resource &r, OptsData &d);
        static int l2_memlat_ratio_ceil_0(Resource &r, OptsData &d);
        static int l2_memlat_ratio_ceil_1(Resource &r, OptsData &d);
