...
# com.qualcomm.qti.imscmservice@1.1 service

HIDL_ROOT_DIR="$QCPATH/ims-ship/rcs/interfaces/"
LIBHIDL_COMPONENT='-r android.hidl:system/libhidl/transport'

IMS_CM_INTERFACE_LIB='com.qualcomm.qti.imscmservice@1.1'

LOC="$QCPATH/ims-ship/rcs/interfaces/imscmservice/1.1/default"
