...
#define SEC_UI_SAMPLE_APP_NAME_TOUCH_32BIT   "secure_ui_sample_touch"
#define SEC_UI_SAMPLE_APP_NAME_TOUCH_64BIT   "secure_ui_sample_touch64"
...
int main(int argc, char *argv[])
{
	...
	if(2 == argc || 3 == argc){
		...
		if (2 == argc){
			...
			if(!strncmp(SEC_UI_SAMPLE_APP_NAME_TOUCH_32BIT, argv[2],strlen(SEC_UI_SAMPLE_APP_NAME_TOUCH_32BIT))) {
				printf("running with app:%s\n",SEC_UI_SAMPLE_APP_NAME_TOUCH_32BIT);
				g_app_name = SEC_UI_SAMPLE_APP_NAME_TOUCH_32BIT;
			}
			else if(!strncmp(SEC_UI_SAMPLE_APP_NAME_TOUCH_64BIT, argv[2],strlen(SEC_UI_SAMPLE_APP_NAME_TOUCH_64BIT))) {
				printf("running with app:%s\n",SEC_UI_SAMPLE_APP_NAME_TOUCH_64BIT);
				g_app_name = SEC_UI_SAMPLE_APP_NAME_TOUCH_64BIT;
			}
			else if(!strncmp("32bit", argv[2],5)){
				printf("running with 32 bit secure_ui_sample app\n");
				g_app_name = SEC_UI_SAMPLE_APP_NAME_32BIT;
