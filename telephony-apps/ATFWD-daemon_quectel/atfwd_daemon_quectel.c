...
qmi_atcop_at_cmd_fwd_req_type atCmdFwdReqType[] = {
    ...
    { //AT command fwd type	// add for qdevinfo by klcib 20181119
        1, // Number of commands
        {
            { QMI_ATCOP_AT_CMD_NOT_ABORTABLE, "+QDEVINFO"},//#ifdef QUECTEL_QDEVINFO_CMD
        }
    },
#endif
    ...
    { //AT command fwd type	// add for qdevinfo by klcib 20181119
        1, // Number of commands
        {
            { QMI_ATCOP_AT_CMD_NOT_ABORTABLE, "+QAPCMD"},//#ifdef QUECTEL_QAPCMD_CMD
        }
    },
#endif	  
};
