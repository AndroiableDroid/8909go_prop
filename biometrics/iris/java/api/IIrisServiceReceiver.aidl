...
/**
 * Communication channel from the IrisService back to IrisManager.
 * @hide
 */
oneway interface IIrisServiceReceiver {
    ...
    void onAuthenticationProgress(long deviceId, in IrisOperationStatus status);
    void onAuthenticationSucceeded(long deviceId, in Iris irisInfo);
