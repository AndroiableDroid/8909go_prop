...
static int update_ts_info_callback(input_absinfo * abs_x, input_absinfo * abs_y, void *data) {
    ...
    g_input_adjust.ts_x_max = abs_x->maximum;//730
    g_input_adjust.ts_x_min = abs_x->minimum;//0
    g_input_adjust.ts_y_max = abs_y->maximum;//1285
    g_input_adjust.ts_y_min = abs_y->minimum;//0
    g_input_adjust.lcd_x = get_fb_width();//720
    g_input_adjust.lcd_y = get_fb_height();//1280
    g_input_adjust.valid = 1;

    if(g_input_adjust.ts_x_max - g_input_adjust.ts_x_min > 0)
        g_input_adjust.ratio_x = (float)g_input_adjust.lcd_x / (g_input_adjust.ts_x_max - g_input_adjust.ts_x_min);
    else
        g_input_adjust.ratio_x = 0;

    if(g_input_adjust.ts_y_max - g_input_adjust.ts_y_min > 0)
        g_input_adjust.ratio_y = (float)g_input_adjust.lcd_y / (g_input_adjust.ts_y_max - g_input_adjust.ts_y_min);
    else
