...
garden_state_initialized::garden_state_initialized(GardenAPIClient * a_gps_interface): garden_state_base(),
...
garden_state_session_off:: garden_state_session_off(GardenAPIClient * a_gps_interface): garden_state_base(),
                            m_gps_interface(a_gps_interface)
{
}
...
garden_state_session_on::garden_state_session_on(GardenAPIClient * a_gps_interface): garden_state_base(),
                            m_gps_interface(a_gps_interface)
{
}
...
bool  garden_state_session_on::state_action()
{
    ...
    m_gps_interface->gnssSetPositionMode(GNSS_SUPL_MODE_MSB, 1000, 0);
...
garden_state_gps_off::garden_state_gps_off(GardenAPIClient * a_gps_interface): garden_state_base(),
                        m_gps_interface(a_gps_interface)
{
}
...
garden_app_session_tracker::garden_app_session_tracker(GardenAPIClient * a_gps_interface):
