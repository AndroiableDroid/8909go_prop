...
private:
    GardenAPIClient          *m_gps_interface;
public:
    garden_state_initialized(GardenAPIClient * a_gps_interface);
...
private:
    GardenAPIClient          *m_gps_interface;
public:
    garden_state_session_off(GardenAPIClient * a_gps_interface);
...
private:
    GardenAPIClient          *m_gps_interface;
public:
    garden_state_session_on(GardenAPIClient * a_gps_interface);
...
private:
    GardenAPIClient          *m_gps_interface;
public:
    garden_state_gps_off(GardenAPIClient * a_gps_interface);
...
public:
    garden_app_session_tracker(GardenAPIClient *a_gps_interface);
