...
public interface IZatGeofenceService {
     ...
     *         be an string as the name of the geofence, or it can be a
   ...
   /**
     * Register a PendingIntent.
     * See <a href="https://developer.android.com/reference/android/app/PendingIntent.html">
     * PendingIntent</a>
     * <p>
     * This allows applications to register an intent and a target action that
     * the service can perform on its behalf. If there
     * is already an intent registered, then the new intent will
     * override the existing one.
     * If application goes away and there is no registered PendingIntent,
     * its added geofences will be removed from the service.
     * If application goes away and there is a registered PendingIntent,
     * its added geofences will continue to exist and the supplied PendingIntent
     * will be executed on a breach event.
     * Extra data will be added to the PendingIntent to include:
     * <ol>
     ...
     * key-value pair </li>
     * <li> The context object when geofence was added with the
     * ("context-data", String) or ("context-data", Bundle) key-value pair </li>
     * </ol>
     *  </p>
     * @param  geofenceIntent the application intent.
     *         In case a null intent is passed a {@link IZatIllegalArgumentException}
     *         will be thrown.
     * @throws IZatIllegalArgumentException
     */
  ...
  /**
     * Unregister a PendingIntent.
     * See <a href="https://developer.android.com/reference/android/app/PendingIntent.html">
     * PendingIntent</a>
     * <p>
     * This allows applications to unregister a previously registered PendingIntent. </p>
     * @param  geofenceIntent the application intent.
     *         In case a null intent is passed a {@link IZatIllegalArgumentException}
     *         will be thrown.
     * @throws IZatIllegalArgumentException
     ...
     * Recover geofences.
     * <p>
     * This allows applications to query for its added geofences at any time.
     * Typical use case will be if application goes away after adding geofences, and
     * is launched back (manually or via PendingIntent {@link registerPendingIntent} )
     * it can query all its previously added geofences.
     * Geofences added without registering for a PendingIntent, cannot
     * be recovered. </p>
     * @return Map of handle binding the geofence {@link IZatGeofenceHandle}
    ...
    interface IZatGeofenceHandle {
         ...
         * <p>
         * This allows applications to resume a paused geofence. </p>
         * <p> If the geofence associated with this handle has been removed,
         * the handle will no longer be valid, so there will be no geofence
    ...
    public class IzatGeofence {
         ...
         * @param  longitude indicating the longitude in degrees, between -180 and +180 inclusive.
    ...
    public enum IzatGeofenceConfidence {
        /**
         * Low confidence: Lower power usage, it can impact the yield because incorrect transition events may be sent.
         */
        LOW(1),
        /**
         * Medium confidence.
        ...
        MEDIUM(2),
        /**
         * High confidence: This setting results in higher power usage and best transition events accuracy.
         */
        HIGH(3);
