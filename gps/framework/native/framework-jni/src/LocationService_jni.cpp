...
#include <vendor/qti/gnss/1.1/ILocHidlGnssNiCallback.h>
#else
...
using ::vendor::qti::gnss::V1_1::ILocHidlGnssNiCallback;
#else
...
#else
            auto gnssNiVendor = vendorGnss->getExtensionLocHidlGnssNi_1_1();
#endif
...
#else
            auto agnssVendor = vendorGnss->getExtensionLocHidlAGnss_1_1();
#endif
