...
#include <vendor/qti/gnss/1.1/ILocHidlGeofenceServiceCallback.h>
#else
...
using ::vendor::qti::gnss::V1_1::ILocHidlGeofenceServiceCallback;
#else
...
#else
            auto geofence = gnssVendorHal->getExtensionLocHidlGeofenceService_1_1();
#endif
