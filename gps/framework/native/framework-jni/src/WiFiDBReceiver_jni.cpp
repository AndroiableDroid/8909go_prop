...
#include <vendor/qti/gnss/1.1/ILocHidlWiFiDBReceiverCallback.h>
#else
#include <vendor/qti/gnss/1.0/ILocHidlGnss.h>
#include <vendor/qti/gnss/1.0/ILocHidlWiFiDBReceiverCallback.h>
#endif

#ifdef LOC_HIDL_VERSION_1_1
using ::vendor::qti::gnss::V1_1::ILocHidlGnss;
using ::vendor::qti::gnss::V1_1::ILocHidlWiFiDBReceiver;
using ::vendor::qti::gnss::V1_1::ILocHidlWiFiDBReceiverCallback;
#else
...
#else
            auto wdr = gnssVendorHal->getExtensionLocHidlWiFiDBReceiver_1_1();
#endif
