        ...
        do {
            ...
            for (; it != mDataItemList.end(); it++) {
                ...
                switch (dataItem->getId())
                {
                    ...
                    {
                        WifiHardwareStateDataItem *wifiState = static_cast<WifiHardwareStateDataItem*>(dataItem);
                    ...
                    case WIFI_SUPPLICANT_STATUS_DATA_ITEM_ID:
                    {
                        ...
                        WifiSupplicantStatusDataItem *wifiSupplicantStatus = static_cast<WifiSupplicantStatusDataItem*>(dataItem);
                    ...
                    {
                        PowerConnectStateDataItem *powerState = static_cast<PowerConnectStateDataItem*>(dataItem);
                        mWiperObj->mLbsAdapter->chargerStatusInject(powerState->mState?CHARGER_ON:CHARGER_OFF);
                    }
                    break;
                    case SHUTDOWN_STATE_DATA_ITEM_ID:
                    {
                        ShutdownStateDataItem *shutdownState = static_cast<ShutdownStateDataItem*>(dataItem);
